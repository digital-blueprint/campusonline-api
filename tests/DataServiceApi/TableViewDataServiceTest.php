...
use Dbp\CampusonlineApi\DataServiceApi\TableViewDataServiceApi;
...
class TableViewDataServiceTest extends TestCase
{
    private ?TableViewDataServiceApi $dataServiceApi = null;
    ...
    public function setUp(): void
    {
        ...
        $this->dataServiceApi = new TableViewDataServiceApi($connection, 'loc_apiProjekte');

        $this->mockResponses([]);
    }

    private function mockResponses(array $responses, &$container = []): void
    {
        $history = Middleware::history($container);
        $stack = HandlerStack::create(new MockHandler($responses));
        $stack->push($history);
        $this->dataServiceApi->getConnection()->setClientHandler($stack);
    }
    ...
    public function testGetSingle()
    {
        ...
        $item = $this->dataServiceApi->getResource('ID', 'F123');
    ...
    public function testGetSingleInteger()
    {
        ...
        $item = $this->dataServiceApi->getResource('ID', '42');
        $this->assertNotNull($item);
    ...
    public function testLanguage()
    {
        ...
        $x = $this->dataServiceApi->getResourceCollection(options: [Options::LANGUAGE => 'fr']);
    ...
    public function testGetSingleNonUniqueField()
    {
        ...
        $this->dataServiceApi->getResource('ID', '42');
    }
    ...
    public function testGetSingleFieldTypeMismatch()
    {
        ...
        $item = $this->dataServiceApi->getResource('ID', 'foobar');
        $this->assertNull($item);
    ...
    public function testGetTwo()
    {
        ...
        $items = $this->dataServiceApi->getResourceCollection([], 0, 2);
    ...
    public function testGetPage()
    {
        ...
        $items = $this->dataServiceApi->getResourcePage([], 1, 6);
        ...
        $items = $this->dataServiceApi->getResourcePage([], 1, 5);
        $this->assertCount(2, $items);
        ...
        $items = $this->dataServiceApi->getResourcePage([], 1, 3);
